...
class BFCompilerX64:
    ...
    comp_strm: BFOptimizer
    comp_asm: list[str]
    comp_mem_ptr: int
    def __init__(self: typing.Self, comp_strm: BFOptimizer) -> None:
        self.comp_strm = comp_strm
        self.comp_asm = []
        self.comp_mem_ptr = 0
    def compile(self: typing.Self) -> str | None:
        strm: BFOptimizer = self.comp_strm
        config: BFConfig = strm.opt_parser.bfp_config
        ip: int = 0
