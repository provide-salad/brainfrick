...
class BFOptimizer:
    __slots__ = ("opt_parser", "opt_queue", "opt_queue_idx", "opt_lazy_seek_offset", "opt_lazy_seek_reference", "opt_loops", "opt_loop_number", "opt_mem")
    opt_parser: "BFParser"
    ...
    def abs_seek(self: typing.Self, offset: int) -> None:
        config: BFConfig = self.opt_parser.bfp_config
